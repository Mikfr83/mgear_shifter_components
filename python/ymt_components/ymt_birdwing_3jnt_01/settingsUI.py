"""Qt settings UI for ymt_birdwing_3jnt_01."""
...
class Ui_Form(object):
    def setupUi(self, Form: QtWidgets.QWidget) -> None:
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.ikSolver_label)
        ...
        self.softIKRange_label = QtWidgets.QLabel(self.groupBox)
        self.softIKRange_label.setObjectName("softIKRange_label")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.softIKRange_label)
        self.softIKRange_spinBox = QtWidgets.QDoubleSpinBox(self.groupBox)
        self.softIKRange_spinBox.setDecimals(4)
        self.softIKRange_spinBox.setMinimum(0.0)
        self.softIKRange_spinBox.setMaximum(1.0)
        self.softIKRange_spinBox.setSingleStep(0.01)
        self.softIKRange_spinBox.setObjectName("softIKRange_spinBox")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.softIKRange_spinBox)

        self.softIKSpeed_label = QtWidgets.QLabel(self.groupBox)
        self.softIKSpeed_label.setObjectName("softIKSpeed_label")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.softIKSpeed_label)
        self.softIKSpeed_spinBox = QtWidgets.QDoubleSpinBox(self.groupBox)
        self.softIKSpeed_spinBox.setDecimals(3)
        self.softIKSpeed_spinBox.setMinimum(1.001)
        self.softIKSpeed_spinBox.setMaximum(10.0)
        ...
        self.ikRefArray_verticalLayout_2.addItem(
        ...
        self.upvRefArray_verticalLayout_2.addItem(
            QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        )
    ...
    def retranslateUi(self, Form: QtWidgets.QWidget) -> None:
        ...
        self.smoothStep_checkBox.setToolTip(
            gqt.fakeTranslate("Form", "Smooth shoulder connection interpolation when connected to ymt_shoulder_01.", None, -1)
        )
        self.smoothStep_checkBox.setText(gqt.fakeTranslate("Form", "Shoulder Smooth Step", None, -1))
